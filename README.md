...
### VERSION HISTORY
    ...
    v1.9 06/02/2013 - (CURRENT) add the --ignore-originals flag for modders who really want to see what happens when they try to break things.
    v1.8 03/25/2013 - Add support for AssistantMic-163r@1x~ipad.artwork -- found only on the iPad Mini firmware, not even in the SDK
